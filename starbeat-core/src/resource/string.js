...
<p>此配置文件已经过作者测试，但倘若您要使用此配置文件，仍需自行承担由此造成的直接或间接风险，包括但不限于软件损坏、数据丢失、硬件损坏等。作者和贡献者将不对这些风险承担任何形式的责任。</p>`,
        ...
        useAirportItlwm: "使用原生接口 Intel 驱动 (AirportItlwm)",
        ...
        personalize: "个性化设置",
        specialSetting: "特殊设置",
        useLegacyBatteryDriver: "使用兼容电池驱动",
        useLegacyBatteryDriverDescription: "使用 ACPIBatteryManager.kext 代替 SMCBatteryManager.kext，以解决部分场景下 kernel_task 进程占用过高 CPU 的问题",
        ...
        setBackgroundDescription: "选择一张图片作为 OpenCore 引导程序的背景。为了保证效果，请自行裁切分辨率为 1920x1080 或 3840x2160；仅支持 png 或打包好的 icns 格式图片。",
    ...
    en: {
        ...
        useLegacyBatteryDriver: "Use legacy ACPI driver",
        useLegacyBatteryDriverDescription: "Replace SMCBatteryManager.kext with ACPIBatteryManager.kext to avoid the kernel_task process stuck sometimes.",
        smbiosInfo: "SMBIOS",
...
<p>Authors and contributors are not guaranteed for any damage of your device.</p>`,
        ...
        specialSetting: "Special Settings",
