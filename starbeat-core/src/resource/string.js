...
点击“我同意”则表示您已经阅读并知悉上述许可协议。App 将开始下载配置文件。`,
        ...
        continue: '继续使用',
        downloadingAssistPackage: "正在下载驱动拓展包，请稍等，视网络环境不同，这可能需要几分钟的时间...如果长时间没有响应，请尝试按 Ctrl+R 重载页面。",
        downloadDone: '拓展包下载完成。',
        downloadingVoiceOver: "正在下载无障碍语音包，请稍等。由于语音包体积较大，视网络环境不同，这可能需要几分钟的时间...如果长时间没有响应，请尝试按 Ctrl+R 重载页面。",
...
If you installed Samsung PM981(a), Micron 2200s or other NVMe drives that are not compatible with macOS, check "Disable incompatible NVMe", and plug the incompatible SSD in m.2 slot 1.`,
        ...
        selectOtherModel: "Select other model",
        filterModel: "Search model..",
        approve: "OK",
        cancel: "Cancel",
        approveLicense: "I approve",
        dontApproveLicense: "I don't approve",
        downloadingVoiceOver: "Please wait until the VoiceOver package downloaded. This can take a few minutes...",
        voiceOverDone: "VoiceOver package downloaded.",
        accessibility: "Enable Accessibility",
        voiceOverNotDownloaded: "Accessibility mode requires extra download of VoiceOver package. Do you want to download it?",
        accessibilityDescription: "Accessibility mode can help those who have troble reading screen text to use their computer. Once you enable the accessibility mode, OpenCore will enable picker voice assist and disable GUI. Do you want to enable the accessibility mode?",
